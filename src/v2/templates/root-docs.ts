...
This repository uses \`llm-docs\` v2 as a local-first task bundle and context operations layer.
...
<!-- llm-docs:start -->
This repository uses \`llm-docs\` v2 as a task bundle and context operations layer for coding agents.
