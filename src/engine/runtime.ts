...
export async function createRuntime(projectRoot: string, options: LoadOrMigrateConfigOptions = {}) {
...
export type LlmDocsRuntime = Awaited<ReturnType<typeof createRuntime>>;
