...
import { createTaskBundle } from '../../src/engine/task/bundle.js';
import { appendChangelogEpoch } from '../../src/engine/task/changelog.js';
import { saveContextCheckpoint } from '../../src/engine/task/checkpoint.js';
import { prepareJiraDoc } from '../../src/engine/task/jira-doc.js';
...
async function createTaskWithCheckpoint(
  projectRoot: string,
  taskId: string,
): Promise<Awaited<ReturnType<typeof prepareWorkspace>>> {
