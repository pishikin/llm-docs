...
import { importJiraTaskBundle } from '../../src/v2/integrations/jira/from-jira.js';
import { pullJiraIssue } from '../../src/v2/integrations/jira/pull.js';
import { readArtifactIndex } from '../../src/v2/task/artifacts.js';
...
async function prepareJiraWorkspace(): Promise<Awaited<ReturnType<typeof prepareV2Workspace>>> {
